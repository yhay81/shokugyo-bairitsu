CREATE TABLE IF NOT EXISTS product_events (
  ...
  event_name TEXT NOT NULL CHECK (event_name IN ('visited', 'searched', 'no_result', 'region_changed', 'group_changed', 'employment_changed', 'year_changed', 'occupation_changed', 'compared', 'copied')),
